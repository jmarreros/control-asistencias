...
<div class="px-4 pb-2 pt-2">
    <div class="rounded-xl overflow-hidden border border-white/20">
        <div class="px-4 py-3 border-b border-white/10">
            <p class="text-xs font-semibold text-white/50 uppercase tracking-wide">Actividad</p>
        </div>
        <div class="flex items-center justify-between px-4 py-4">
            <div>
                <p class="text-sm font-medium text-white/90">Logs de acceso</p>
                <p class="text-xs text-white/40 mt-0.5">Historial de accesos al sistema</p>
            </div>
            <a href="{{ route('logs.index') }}"
               class="flex items-center gap-2 bg-indigo-600 text-white text-sm font-medium px-4 py-2 rounded-xl shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.293.707V19a2 2 0 01-2 2z M13 2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2V9z"/>
                </svg>
                Ver logs
            </a>
        </div>
